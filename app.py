...
from db import get_user, save_user, save_room, add_room_members, get_rooms_for_user, get_room, is_room_member,get_room_members,\
...
def edit_room(room_id):
    ...
    if room and is_room_admin(room_id, current_user.username):
        ...
        if request.method == 'POST':
            ...
            message = 'Room editted successfully'
